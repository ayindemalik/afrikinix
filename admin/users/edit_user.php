...
<head>
  ...
  <title>Admin-Users- Edit user</title>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-7">
                    <div class="p-5">
                      ...
                      <!-- </div> -->
                      <form class="user" action="edit_user.php" method="post">

                        <div class="form-group">
                          <?php include(ROOT_PATH."/app/helpers/formErrors.php");?>
                        </div>
                        <input type="hidden" name="user_id" value="<?php echo $user_id?>"  class="text-input">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <button type="submit" name="admin-save-user-update" class="btn btn-primary btn-user btn-block">
                            Save User</button>
                        </div>
                      </form>
                    </div>
