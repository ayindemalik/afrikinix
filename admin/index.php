...
$blog_posts = selectAll("blog_posts");
$projects = selectAll("projects");
$theses = selectAll("theses");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Totol Thesis</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo count($theses)?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo count($articles)?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Blog posts</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo count($blog_posts)?></div>
                    </div>
                    <div class="col-auto">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Main Admin Operations</h6>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6 mb-4">
                ...
                <div class="col-lg-6 mb-4">
                  <a href="<?php echo BASE_URL."/admin/theses/index.php"?>">
                ...
                <div class="col-lg-6 mb-4">
                  <a href="<?php echo BASE_URL."/admin/articles/index.php"?>">
