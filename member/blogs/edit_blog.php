              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <input type="text" name="post_id" id="post_id" class="form-control input-sm input"
                              value="<?php echo $post_id ?>" placeholder="0123456" readonly/>
                  ...
                  <div class="my-2"></div>
                  <input type="submit" name="mem_save_up_blop" id="mem_save_up_blop" class="btn btn-secondary btn-icon-split form-control"
                  value="Save blog update">
                </form>
                </div>
              </div>
            </div>
