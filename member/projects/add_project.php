...
<head>
  ...
  <title>Member - Article - add project</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add new project</h1>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <input type="text" name="project_id" id="project_id" class="form-control input-sm input"
                              value="<?php echo count(selectAll($tb_projects))+1;?>" placeholder="0123456" readonly/>
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        <select id="domain_field" name="domain_field" class="form-control">
                          <?php
                            if (!empty($domain_field) && $domain_field != ""){
                              echo '<option selected value="'.$domain_field.'">'.$domain_field.'</option>';
                            }
                            // endif;
                           ?>
                          <option value="" selected="selected">Add Domain Field</option>
                          <?php foreach ($domain_fields as $key => $domain_f): ?>
                            <?php if (!empty($domain_id) && $domain_id == $domain_f['domain_id']):?>
                  ...
                  <div class="my-2"></div>
                  <input type="submit" name="save_project" id="save_project" class="btn btn-secondary btn-icon-split form-control"
                  value="Save project">
                </form>
                </div>
              </div>
