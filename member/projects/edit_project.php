...
<head>
  ...
  <title>Member - project - edit project</title>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <input type="text" name="project_name" id="project_name" class="form-control input-sm input"
                              value="<?php echo $project_name ?>" placeholder="The title of the of the project" />
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <input type="text" name="institution" id="institution" class="form-control input-sm input"
                            value="<?php echo $institution ?>" placeholder="Institution name"/>
                      </div>
                  </div>

                  <div class="my-2">Select project file (pdf)</div>
                  <input type="file" name="project_image" id="project_image" class="form-control input-sm input"
                      value="" placeholder="select file"/>

                  <div class="my-2"></div>
                  <input type="submit" name="mem_save_up_project" id="mem_save_up_project" class="btn btn-secondary btn-icon-split form-control"
