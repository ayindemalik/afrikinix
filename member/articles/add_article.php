...
<head>
  ...
  <title>Member - Article - add new article</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add new article</h1>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <input type="text" name="article_id" id="article_id" class="form-control input-sm input"
                              value="<?php echo count(selectAll($tb_article))+1;?>" placeholder="0123456" readonly/>
                  ...
                  <div class="my-2"></div>
                  <input type="submit" name="save_article" id="save_article" class="btn btn-secondary btn-icon-split form-control"
                  value="Save Article">
                </form>
                </div>
              </div>
