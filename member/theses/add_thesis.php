...
<head>
  ...
  <title>Member - theses - add thesis</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Add new thesis</h1>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                        <input type="text" name="thesis_id" id="thesis_id" class="form-control input-sm input"
                              value="<?php echo count(selectAll($tb_theses))+1;?>"
                  ...
                  <div class="col-lg-6">
                        ...
                        <div class="my-2"></div>
                        <input type="submit" name="save_thesis" id="save_thesis" class="btn btn-secondary btn-icon-split form-control"
                        value="Save thesis">
